...
import 'package:htmlparserexample/main.dart';
...
class CustomDrawerState extends State<CustomDrawer>
  ...
  ListView _menuGenresList() {
    ...
    changeThemeLight(){
    ThemeApp.of(context).switchTheme(MyThemeKeys.LIGHT);
    }

    changeThemeDark(){
      ThemeApp.of(context).switchTheme(MyThemeKeys.DARK);
    }

    changeThemeDarker(){
      ThemeApp.of(context).switchTheme(MyThemeKeys.DARKER);
    }
  ...
  Widget build(BuildContext context) {
    return Drawer(
      child: Container(
          decoration: new BoxDecoration(color: MyColorsTheme2.primary1(2)),
